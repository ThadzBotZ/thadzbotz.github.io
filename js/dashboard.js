...
function getvisitor(){
    var xhr = new XMLHttpRequest();
    var url = 'https://api.countapi.xyz/hit/web/thadzbotz.herokuapp.com';
    xhr.onloadend = function(){
    data = JSON.parse(this.responseText);
...
var batteryLevel = document.getElementById("batteryLevel");
	...
	const Image = ["https://telegra.ph/file/919b1c8bed2b11880e596.jpg", "https://telegra.ph/file/919b1c8bed2b11880e596.jpg"]
